...
/**
 * The {@link JobWorker} uses this interface to determine the delay between each failed requests.
 ...
 *
 * <p>The supplier is called after a failed request, before the next request, and the worker will
 * then await the supplied delay before sending the next request.
 */
@FunctionalInterface
