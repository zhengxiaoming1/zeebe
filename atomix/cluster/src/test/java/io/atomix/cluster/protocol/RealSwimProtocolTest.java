...
public class RealSwimProtocolTest extends ConcurrentTestCase {
  ...
  @Test
  public void shouldRemoveNodeOnPart2131ition() throws Exception {
    // Start a node and check its events.
    startProtocol(member1);
    startProtocol(member2);
    startProtocol(member3);
    ...
    awaitMembers(member3, member3);
    clearEvents(member1, member2, member3);

    partition(member1);

    // Verify that node 3 was removed from nodes 1 and 2.
    awaitMembers(member2, member2);
    awaitMembers(member1, member1);
    awaitMembers(member3, member3);
    clearEvents(member1, member2, member3);
    //
    //    // Node 3 should also see REACHABILITY_CHANGED and MEMBER_REMOVED events for nodes 1 and
    // 2.
    //    checkEvents(
    //        member3,
    ...
    awaitMembers(member2, member2, member3);
    awaitMembers(member3, member3, member2);
    //    checkEvent(member2, MEMBER_ADDED, member3);
    //    checkEvent(member3, MEMBER_ADDED, member2);
  }
  ...
  private void awaitMembers(final Member member, final Member... members) {
    ...
    Awaitility.await()
        ...
        .until(protocol::getMembers, expectedMembers::equals);
  }
