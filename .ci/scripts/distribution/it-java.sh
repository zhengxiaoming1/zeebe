...
mvn -o -B --fail-never -s ${MAVEN_SETTINGS_XML} verify -P skip-unstable-ci -pl qa/integration-tests -DtestMavenId=2 -Dsurefire.rerunFailingTestsCount=7 | tee ${tmpfile}
